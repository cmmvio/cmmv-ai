...
import { CohereEmbedding } from '../../src/embeddings/cohere.embedding';
import { AbstractEmbedding } from '../../src/embeddings/embedding.abstract';

vi.mock('@langchain/cohere', () => ({
    CohereEmbeddings: vi.fn().mockImplementation(() => ({
...
describe('CohereEmbedding', () => {
    let embedding: CohereEmbedding;

    beforeEach(() => {
        vi.clearAllMocks();
        embedding = new CohereEmbedding();
    });
