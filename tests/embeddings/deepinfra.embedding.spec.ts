...
import { DeepInfraEmbedding } from '../../src/embeddings/deepinfra.embedding';
import { AbstractEmbedding } from '../../src/embeddings/embedding.abstract';

vi.mock('@langchain/community/embeddings/deepinfra', () => ({
    DeepInfraEmbeddings: vi.fn().mockImplementation(() => ({
...
describe('DeepInfraEmbedding', () => {
    let embedding: DeepInfraEmbedding;

    beforeEach(() => {
        vi.clearAllMocks();
        embedding = new DeepInfraEmbedding();
    });
